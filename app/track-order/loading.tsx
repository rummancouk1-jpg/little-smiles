  ...
  return (
    <main className="min-h-screen bg-surface-grain px-4 py-10 sm:px-6 lg:px-8">
      <section className="mx-auto max-w-3xl space-y-5">
        <header className="space-y-3 rounded-3xl border border-ink-base/10 bg-surface-raised/88 p-6 sm:p-8">
        ...
        <div className="h-72 animate-pulse rounded-3xl bg-surface-raised/90" />
      </section>
    </main>
  );
}
